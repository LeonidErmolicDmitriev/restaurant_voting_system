package com.github.leonidermolicdmitriev.restaurant_voting_system.web.user;

import com.github.leonidermolicdmitriev.restaurant_voting_system.to.UserTo;
...
import com.github.leonidermolicdmitriev.restaurant_voting_system.web.GlobalExceptionHandler;
...
import com.github.leonidermolicdmitriev.restaurant_voting_system.repository.UserRepository;
import com.github.leonidermolicdmitriev.restaurant_voting_system.util.UserUtil;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        UserTestData.USER_MATCHER.assertMatch(userRepository.findAll(), List.of(UserTestData.admin, UserTestData.user2, UserTestData.user3));
    }
